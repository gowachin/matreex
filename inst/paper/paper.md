...
`matreex` was designed to be easily adapted to various research ideas and is in continuous development. It has been used in different scientific publications tackling diverse scientific questions [@kunstler2021; @guyennon2023; @barrere2024; @barrereprep; @barangerprep]. The ability to simulate forests easily with a dedicated R package will help ecologists analyse the effect of climate change, shifting disturbance regimes, and their interplay with forest management across European forests.
