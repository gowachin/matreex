...
## Monospecific case
### Harvest rate
We note H the global harvest rate wich will determine the amount of basal area to be harvested.
...
ggplot(df, aes(x=dbh, y=h)) + geom_line(col='red') + theme_bw(base_size=30) +
	geom_label(aes(x=dth, y=0, label='dth'), size=15) +
	geom_label(aes(x=dha, y=0, label='dha'), size=15) +
	geom_label(aes(x=dha-10, y=0.8, label='hmax'), size=15) +
