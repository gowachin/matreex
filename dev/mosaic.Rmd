...
The recruitment function for a species $s$ in a single path ($R_s = \alpha BA_s^\beta \cdot e^{-\delta BA_s} \cdot e^{-\epsilon BA_h}$) is modified to account for the flaw of seed from a regional pool as follow:
