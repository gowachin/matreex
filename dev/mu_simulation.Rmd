...
Abies_alba <- new_species(IPM = mu_Abies_alba, init_pop = def_initBA(20), 
                           harvest_fun = def_harv)

forest <- new_forest(species = list(mu_Abies = Abies_alba))
set.seed(42)
...
Abies_alba <- new_species(IPM = mu_Abies_alba, 
...
```{r}
nsp_forest <- new_forest(species = list(Picea = Picea_abies, Abies = Abies_alba))
set.seed(42)
...
msp_forest <- new_forest(species = list(Picea = Picea_abies_ipm, Abies = Abies_alba))
set.seed(42)
