...
ggplot(df, aes(x=dbh, y=h)) + geom_line(col='red') + theme_bw(base_size=30) +
	geom_label(x=dth, y=0, label=TeX("$d_{th}$"), size=15) +
	geom_label(x=dha, y=0, label=TeX("$d_{ha}$"), size=15) +
	geom_label(x=dha-10, y=hmax, label=TeX("$h_{max}$"), size=15 ) +
