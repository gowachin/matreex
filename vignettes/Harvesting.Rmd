...
Because the species parameters are given in @Aussenac2021 for a single species stand, computing $n_{max}$ and $Dg$ for multispecific stands in not straight forward. 
...
$$Dg^2 = \frac{\sum_{s=1}^{S} \sum_{n=1}^{mesh} d_{s,n} \cdot DBH_{s,n}^2}{\sum_{s=1}^{S} N_{s}}$$
