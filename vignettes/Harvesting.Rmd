...
$h_{max} =  1 - \sqrt[n]{1-p}$ with $n$ the number of harvesting operations. Parameter $k$ defines how quickly the harvesting rate increase from $d_{th}$  to $d_{ha}$ (building on the approach used in previous model such as @guillemot2014).
...
```{r Comp_rdi, fig.cap="Dashed lines represent RDI and Kg targets. Both values where set to 0.9."}
