...
When plotting the evolution of BA in comparison with no delay, we observe a larger BA and an equilibrium reached later in time.
...
This difference in BA is linked with a different distribution at equilibrium.
