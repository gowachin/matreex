...
set.seed(42)
res <- sim_deter_forest(Forest, tlim = 100, equil_time = 1e3,
...
set.seed(42)
res <- sim_deter_forest(Forest2, tlim = 100, equil_time = 1e3,
                 correction = "cut", equil_dist = 50,
                 verbose = TRUE)
...
plot(times, colSums(res[grepl("BA",rownames(res)),]), 
     type = "b", ylab = "Total BA", xlab = "time", cex = 0.1)
```
