...
Here is an example where we start from $t = 150$ of the previous simulation. This will illustrate that despite the simulation said it reached equilibrium at time $t = 244$, our parameters have introduce a bias. The previous equilibrium is highlighted in blue rectangle.
