...
The `{treeforce}` package use Integral Projection Model (IPM here after) for tree growth and survival models. Each IPM is defined for a given climate (*sggd* and *wai* variables) and competition (*BA* variable).
