...
test_that("def_init works", {
    ...
    expect_equal(
        def_init(x),
        c(5.18307596765353, 5.17059364762027, 5.1581413885613, 5.14571911808125,
          5.13332676395911, 5.12096425414777)
    )
    ...
    expect_equal(
        foo(x),
        c(103.661519353071, 103.411872952405, 103.162827771226, 102.914382361625,
          102.666535279182, 102.419285082955)
    )
