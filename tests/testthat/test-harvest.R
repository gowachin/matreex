...
test_that("sim_rdikg works", {
    ...
    expect_equal(
        ...
        structure(list(
            ...
            value = c(0.000600719006467864, 0.000576424651298414, 0.000387234232293168,
                      0.000360953791346879, 0.000213484774174696, 0.000215470859951534,
                      93.3004239364435, 93.3004239364435, 1, 93.9497876295814, NaN,
                      0)),
